...
const SimulIPR = ({
  ...
  const [valCadre, setValCadre] = useState(0);
  const [limTrans, setLimTrans] = useState(0);

  //const transLimit = (grade == 'CADRE')
  ...
  let nbrCourses = form.watch("nbrCourses");

  useEffect(() => {
    console.log("Grade", grade);
    console.log("NONCADRE", NONCADRE);

    if (grade == "1") {
      trans.forEach((tr: any) => {
        if (tr.grade === "Cadre") {
          //setTranspo(tr.coutCourse * tr.nbrCourses * 26);
          setTranspo(nbrCourses * +CADRE * 26);
          setLimTrans(+MAXCOURSES * +CADRE * 26);
        }
      });
    } else {
      if (grade === "2") {
        trans.forEach((tr: any) => {
          if (tr.grade === "Autre") {
            //setTranspo(tr.coutCourse * tr.nbrCourses * 26);
            setTranspo(nbrCourses * +NONCADRE * 26);
            setLimTrans(+MAXCOURSES * +NONCADRE * 26);
          }
        });
      } else setTranspo(0);
    }
              ...
              {(grade == "1" || grade == "2") && (
                <div className="flex">
                  <FormField
                    ...
                    name="nbrCourses"
                    render={({ field }) => (
                      <FormItem className="mb-2 mt-2 px-2          w-full">
                        <div className=" w-full flex items-center max-md:justify-end justify-end gap-2">
                          <FormLabel className="max-md:w-1/3  text-sky-400 ">
                            Transport
                          </FormLabel>
                          <FormControl className="relative w-full md:w-2/3   text-white font-semibold">
                            <div className="relative flex items-center">
                              <div className="w-full flex items-center gap-2 justify-start">
                                <Input
                                  ...
                                  //   step={0.1}
                                  {...field}
                                  className="border border-neutral-700  bg-[#0e172a] w-1/2"
                                />
                              ...
                              <Label className="text-white w-1/2 text-center font-semibold">
                                $ {transpo} / Mois
                              </Label>
                            </div>
                          </FormControl>
            ...
            <div className=" rounded-lg overflow-hidden  border-2 border-neutral-700  ">
                ...
                {logement > 0 && (
                  <div className="mb-2 mt-2 p-2 w-full flex items-start max-md:justify-between justify-end gap-2">
                    ...
                    <div className=" w-full md:w-2/3 flex justify-end ">
                      <Label className="flex flex-col items-end justify-start whitespace-nowrap font-semibold text-blue-950">
                  ...
                  <div className="mb-2 mt-2 p-2 w-full flex items-start max-md:justify-between justify-end gap-2">
                    ...
                    <div className="w-full md:w-2/3 flex justify-end ">
                      <Label className="flex flex-col items-end justify-start whitespace-nowrap font-semibold text-blue-950">
                        ...
                        <p className="font-extralight mt-2 ">
                          {/*                           {((transpo * 100) / basisSalary).toFixed(2)}%
                           */}{" "}
                          {limTrans * rate}
                          {" CDF"}
                        </p>
                        {transpo - limTrans > 0 && (
                          <span className="mt-2 font-extralight text-red-400">
                            +{formatAmount((transpo - limTrans) * rate, " CDF")}
                          </span>
                        )}
                      </Label>
                      ...
                      <Label className="w-1/3 flex flex-col items-end justify-end whitespace-nowrap text-neutral-500 text-xs">
                        ...
                        {transpo - limTrans > 0 && (
                          <span className="mt-2 font-extralight text-red-400">
                            {/*                             +{buildExtraLog()?.usd}
                             */}{" "}
                            +{formatAmount(transpo - limTrans, " USD")}
                          </span>
                        )}
                      </Label>
                    </div>
              ...
              <div className="mb-2 mt-2 p-2 w-full flex items-center max-md:justify-between justify-end gap-2">
                ...
                <div className="w-full md:w-2/3 grid grid-cols-3 gap-2">
                  ...
                  <Label className="flex items-center justify-end whitespace-nowrap text-neutral-500 text-xs">
                    {formatAmount(
                      +basisSalary + +buildExcLog().USD + +buildExcTrans().USD,
                      " USD"
                    )}
                  </Label>
                </div>
